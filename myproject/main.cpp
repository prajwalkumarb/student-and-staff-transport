...
int student_login::allotmentform()
{
	...
	cout<<endl<<endl<<"\nPh_no:"<<tem[1];
	cout<<"\nADDRESS:"<<tem[2];
	cout<<endl<<endl<<"\nAlloted seat Number:"<<tem[3];
	cout<<endl<<endl<<endl<<"\nTotal amount DUE : Rs "<<tem[4]<<"|-"<<endl<<endl
	<<"                                                             student sign";
...
int main() //functioncall1353
{
	...
	Sleep(10);
	system("COLOR 0");
		char a[]="                \xdb\xdb\xdb\xdb\xdb\xdb\xdb\xdb MIT STDNT & STAF TRANSPORT MGMT \xdb\xdb\xdb\xdb\xdb\xdb\xdb";
		int size;
		size=strlen(a);
	...
	for(int i=0;i<1;i++)
    {
    	...
    	for (x=40;x>1;x--)
   		{
    	  gotoXY(x,y);
    	  cout << "THE DEPARTMENT OF ISE Prajwal B , Prajwal kumar B and Rahul K\n";
    	  Sleep(100);
    	  gotoXY(x,y);
		  cout << "                                                         ";
		     cout<<"                                            ";
  		}
  		cout <<endl<<"THE DEPARTMENT OF ISE\nFROM\n Prajwal B\n Prajwal kumar B\n Rahul K"<<endl;
	}
   register_now r1;
   staff_login s1;
   student_login s2;
